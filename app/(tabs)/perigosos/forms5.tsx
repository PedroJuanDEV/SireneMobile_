...
export default function Forms5Natureza4Perigosos() {
        ...
        >
            <ScrollView contentContainerStyle={formStyles.scrollContent}>
                ...
                <TouchableOpacity style={formStyles.concluirButton} onPress={handleAdvance}>
                    <MaterialIcons name="done-all" size={24} color="#000" />
...
const formStyles = StyleSheet.create({
    ...
    concluirButton: {
        flexDirection: 'row',
        backgroundColor: PERIGOSOS_COLOR_DARK,
        padding: 12,
        borderRadius: 5,
        justifyContent: 'center',
        alignItems: 'center',
