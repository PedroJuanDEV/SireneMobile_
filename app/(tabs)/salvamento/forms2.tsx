// app/(tabs)/Salvamento/forms2.tsx
...
export default function Forms2Natureza3Salvamento() {
    const router = useRouter();
    const [areaOBM, setAreaOBM] = useState('');

    const handleAdvance = () => {
        router.push('/salvamento/forms3'); 
    };
            ...
            <ScrollView contentContainerStyle={formStyles.scrollContent}>
                ...
                <View style={formStyles.mediaRow}>
                    <TouchableOpacity style={formStyles.mediaButton}>
                        <FontAwesome name="camera" size={30} color={SALVAMENTO_COLOR} />
                    </TouchableOpacity>
                    <TouchableOpacity style={formStyles.mediaButton}>
                        <FontAwesome name="video-camera" size={30} color={SALVAMENTO_COLOR} />
                    </TouchableOpacity>
                    <TouchableOpacity style={formStyles.mediaButton}>
                        <MaterialIcons name="folder-open" size={30} color={SALVAMENTO_COLOR} />
                    </TouchableOpacity>
                </View>
