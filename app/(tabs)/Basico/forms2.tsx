...
export default function Forms2Natureza1Basico() {
    const router = useRouter();
    const [areaOBM, setAreaOBM] = useState('');

    const handleAdvance = () => {
        router.push('/Basico/forms3'); 
    };
            ...
            <ScrollView contentContainerStyle={formStyles.scrollContent}>
                ...
                <View style={formStyles.mediaRow}>
                    <TouchableOpacity style={formStyles.mediaButton}>
                        <FontAwesome name="camera" size={30} color={BASICO_COLOR_DARK} />
                    </TouchableOpacity>
                    <TouchableOpacity style={formStyles.mediaButton}>
                        <FontAwesome name="video-camera" size={30} color={BASICO_COLOR_DARK} />
                    </TouchableOpacity>
                    <TouchableOpacity style={formStyles.mediaButton}>
                        <MaterialIcons name="folder-open" size={30} color={BASICO_COLOR_DARK} />
                    </TouchableOpacity>
                </View>
