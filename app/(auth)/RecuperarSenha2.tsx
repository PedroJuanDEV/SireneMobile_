...
const RecuperarSenha2: React.FC = () => {
    ...
    const handleEntrar = () => {
        ...
        Alert.alert('Sucesso', 'Sua senha foi redefinida! Redirecionando para o Login.');
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.formContainer}>
                ...
                <View style={styles.buttonRow}>
                    ...
                    <TouchableOpacity style={[styles.entrarButton, styles.buttonBase]} onPress={handleEntrar}>
...
const styles = StyleSheet.create({
    ...
    entrarButton: { backgroundColor: primaryColor, marginLeft: 10 },
    entrarButtonText: { color: '#FFF', fontSize: 16, fontWeight: 'bold' },
});
